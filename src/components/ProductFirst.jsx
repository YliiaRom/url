    ...
    <>
      ...
      <details>
        ...
        <div>
          ...
          <p>
            export const <span>getProducts = () </span>
            =&gt; &#123; <br />
            return products; <br />
            &#125; <br />
            export const <span>getProductById =</span>
            <span> (productId) </span>=&gt; &#123; <br />
            return products<span>.find(</span>(product) =&gt; product.id ===
            productId); <br />
            &#125;
          </p>
        </div>
      ...
      <p>
        ...
        import <span>&#123;getProducts&#125;</span> from "../fakeApi"; <br />{" "}
        import ProductDetails from "./ProductDetails";
      </p>

      <p>
        ...<mark>function Products() </mark>&#123; <br />
        const <span>product = getProducts();</span> <br />
        return ( <br />
        <span> &lt;ProductList products=&#123;product&#125; /&gt;</span>
      </p>
      <b>2</b>
      <div>
        <p>
